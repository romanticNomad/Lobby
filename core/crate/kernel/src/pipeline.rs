...
//         if let Some(tx_hash) = execution.final_tx_hash() {
//             return Ok(IntentResult::TxHash(tx_hash));
//         }

//         let tx_intent = execution.tx_intent()?;
...
//                 let nonce = self
//                     .nonce_mgr
//                     .reserve(chain_id, from, execution_id)
//                     .await?;

//                 self.state_mgr
//                     .record_nonce(execution_id, nonce)
//                     .await?;
...
//         self.broadcaster
//             .submit(chain_id, execution_id, signed_tx)
//             .await?;
...
//             .transition(
//                 execution_id,
//                 ExecutionState::PendingBroadcast,
//             )
//             .await?;
